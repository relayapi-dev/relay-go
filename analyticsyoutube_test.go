...
func TestAnalyticsYoutubeGetDailyViewsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Analytics.Youtube.GetDailyViews(context.TODO(), relaygo.AnalyticsYoutubeGetDailyViewsParams{
