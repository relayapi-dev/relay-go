...
func TestToolInstagramCheckHashtagSafety(t *testing.T) {
	...
	_, err := client.Tools.Instagram.CheckHashtagSafety(context.TODO(), relaygo.ToolInstagramCheckHashtagSafetyParams{
