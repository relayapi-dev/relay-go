...
- <code title="post /v1/posts/{id}/unpublish">client.Posts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#PostService.Unpublish">Unpublish</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, id <a href="https://pkg.go.dev/builtin#string">string</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#PostUnpublishResponse">PostUnpublishResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
...
- <code title="get /v1/accounts/health">client.Accounts.Health.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountHealthService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountHealthListResponse">AccountHealthListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
...
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupNewResponse">AccountGroupNewResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupUpdateResponse">AccountGroupUpdateResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupListResponse">AccountGroupListResponse</a>

Methods:

- <code title="post /v1/account-groups">client.AccountGroups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupNewParams">AccountGroupNewParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupNewResponse">AccountGroupNewResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="put /v1/account-groups/{id}">client.AccountGroups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupService.Update">Update</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, id <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupUpdateParams">AccountGroupUpdateParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupUpdateResponse">AccountGroupUpdateResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /v1/account-groups">client.AccountGroups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, query <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupListParams">AccountGroupListParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupListResponse">AccountGroupListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="delete /v1/account-groups/{id}">client.AccountGroups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupService.Delete">Delete</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, id <a href="https://pkg.go.dev/builtin#string">string</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
...
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageGetResponse">InboxMessageGetResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageListResponse">InboxMessageListResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageArchiveResponse">InboxMessageArchiveResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageEditResponse">InboxMessageEditResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageSendResponse">InboxMessageSendResponse</a>

Methods:

- <code title="get /v1/inbox/messages/{conversation_id}">client.Inbox.Messages.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageService.Get">Get</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, conversationID <a href="https://pkg.go.dev/builtin#string">string</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageGetResponse">InboxMessageGetResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /v1/inbox/messages">client.Inbox.Messages.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, query <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageListParams">InboxMessageListParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageListResponse">InboxMessageListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="put /v1/inbox/messages/{conversation_id}/archive">client.Inbox.Messages.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageService.Archive">Archive</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, conversationID <a href="https://pkg.go.dev/builtin#string">string</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageArchiveResponse">InboxMessageArchiveResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="patch /v1/inbox/messages/{conversation_id}/{message_id}">client.Inbox.Messages.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageService.Edit">Edit</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, conversationID <a href="https://pkg.go.dev/builtin#string">string</a>, messageID <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageEditParams">InboxMessageEditParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageEditResponse">InboxMessageEditResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="post /v1/inbox/messages/{conversation_id}">client.Inbox.Messages.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageService.Send">Send</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, conversationID <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageSendParams">InboxMessageSendParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#InboxMessageSendResponse">InboxMessageSendResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
...
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactNewResponse">WhatsappContactNewResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactGetResponse">WhatsappContactGetResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactListResponse">WhatsappContactListResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactBulkOperationsResponse">WhatsappContactBulkOperationsResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactImportResponse">WhatsappContactImportResponse</a>

Methods:

- <code title="post /v1/whatsapp/contacts">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactNewParams">WhatsappContactNewParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactNewResponse">WhatsappContactNewResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /v1/whatsapp/contacts/{contact_id}">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.Get">Get</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, contactID <a href="https://pkg.go.dev/builtin#string">string</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactGetResponse">WhatsappContactGetResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /v1/whatsapp/contacts">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, query <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactListParams">WhatsappContactListParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactListResponse">WhatsappContactListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="delete /v1/whatsapp/contacts/{contact_id}">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.Delete">Delete</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, contactID <a href="https://pkg.go.dev/builtin#string">string</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="post /v1/whatsapp/contacts/bulk">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.BulkOperations">BulkOperations</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactBulkOperationsParams">WhatsappContactBulkOperationsParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactBulkOperationsResponse">WhatsappContactBulkOperationsResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="post /v1/whatsapp/contacts/import">client.Whatsapp.Contacts.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactService.Import">Import</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactImportParams">WhatsappContactImportParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappContactImportResponse">WhatsappContactImportResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>

## Groups

Response Types:

- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupNewResponse">WhatsappGroupNewResponse</a>
- <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupListResponse">WhatsappGroupListResponse</a>

Methods:

- <code title="post /v1/whatsapp/groups">client.Whatsapp.Groups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupNewParams">WhatsappGroupNewParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupNewResponse">WhatsappGroupNewResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="get /v1/whatsapp/groups">client.Whatsapp.Groups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, query <a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupListParams">WhatsappGroupListParams</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupListResponse">WhatsappGroupListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
- <code title="delete /v1/whatsapp/groups/{group_id}">client.Whatsapp.Groups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#WhatsappGroupService.Delete">Delete</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, groupID <a href="https://pkg.go.dev/builtin#string">string</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
