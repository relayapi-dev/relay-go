...
- <code title="get /v1/account-groups">client.AccountGroups.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>) (\*<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go">relaygo</a>.<a href="https://pkg.go.dev/github.com/relayapi-dev/relay-go#AccountGroupListResponse">AccountGroupListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
