...
import (
	...
	"github.com/relayapi-dev/relay-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Posts.List(context.Background(), relaygo.PostListParams{})
	if userAgent != fmt.Sprintf("Relay/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Posts.List(context.Background(), relaygo.PostListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Posts.List(cancelCtx, relaygo.PostListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Posts.List(deadlineCtx, relaygo.PostListParams{})
		if err == nil {
