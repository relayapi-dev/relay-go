...
func TestInboxCommentLikeNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Inbox.Comments.Like.New(
		context.TODO(),
		"comment_id",
...
func TestInboxCommentLikeDeleteWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Inbox.Comments.Like.Delete(
		context.TODO(),
		"comment_id",
