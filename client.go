...
// interacting with the relay API. You should not instantiate this client directly,
...
type Client struct {
	...
	Usage         *UsageService
	AccountGroups *AccountGroupService
...
// DefaultClientOptions read from the environment (RELAY_API_KEY, RELAY_BASE_URL).
// This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithHTTPClient(defaultHTTPClient()), option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("RELAY_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("RELAY_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("RELAY_CUSTOM_HEADERS"); ok {
...
// environment (RELAY_API_KEY, RELAY_BASE_URL). The option passed in as arguments
...
func NewClient(opts ...option.RequestOption) (r *Client) {
	...
	r.AccountGroups = NewAccountGroupService(opts...)
	...
	r.Twitter = NewTwitterService(opts...)
	r.Inbox = NewInboxService(opts...)
	r.Reddit = NewRedditService(opts...)
